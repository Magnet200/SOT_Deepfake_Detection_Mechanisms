...
- **Masked Autoencoders enable strong Audio-Visual Early Fusion (CVPR 2024)**: [GitHub](https://github.com/stoneMo/DeepAVFusion.git)
...
- **Circumventing shortcuts in audio-visual deepfake detection datasets with unsupervised learning (arXiv 2025)**: [GitHub](https://github.com/bit-ml/AVH-Align.git)
